                        ...
                        <v-layout>
                            <v-navigation-drawer v-model="this.drawer" temporary width="300">
                                ...
                                <div class="pl-3 listItemSideDrawer">
                                    ...
                                    <v-list-item link title="Catatan Dosen"
                                        @click="this.scrollTo('catatan-dosen')"></v-list-item>
                            ...
                            <div id="windowPreferensi">
                                <div id="contentPreferensi" class="p-4">
                                    ...
                                    <div class="row mb-3 opsiUrutan" id="opsiUrutan1">
                                        ...
                                        <div class="col-3 px-0 d-flex justify-content-center align-items-center">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault"
                                                id="flexRadioDefault1" value="pilihan1" v-model="this.opsiUrutanItemBeranda"
                                    ...
                                    <div class="row mb-3 opsiUrutan" id="opsiUrutan2">
                                        ...
                                        <div class="col-3 px-0 d-flex justify-content-center align-items-center">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault"
                                                id="flexRadioDefault1" value="pilihan2" v-model="this.opsiUrutanItemBeranda"
                    ...
                    <div id="infoDosen" class="mt-3">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="col-12 p-0">
                                <div v-for="(item, index) in this.listTahunAngkatanBimbingan" :key="index" class="col-11 d-flex justify-content-center flex-wrap px-0 mb-2 mx-auto">

                                    <div id="dataAngkatanBimbingan"
                                        class="col-11 d-flex flex-row justify-content-center px-0"
                                    ...
                                    <transition>
                                        <div v-if="this.showInfoAngkatan.get(item)" class="col-12 d-flex justify-content-center">
                                            <div id="infoMahasiswaBimbingan" class="col-10 py-3 mt-1">
                                                ...
                                                <ul v-for="(item, index) in this.jumlahStatusPerwalian.get(item)"
                                                    :key="index" class="mb-2">
                                                    <li class="itemInfoMahasiswaBimbingan">
                                                        <div class="d-flex">
                                                            <p class="col-8 px-0 m-0 ml-1 align-self-center text-left">{{this.statusText[item.status]}}</p>
                                                    ...
                                                    <li class="itemInfoMahasiswaBimbingan">
                                                        <div class="d-flex d-flex justify-content-center">
                                                            ...
                                                            <p class="m-0 align-middle font-weight-bold">
                                                                <router-link
                                                                    :to="{ name: 'DetailAngkatan', params: { id: item, isHover:1 } }">
                                                                    Lihat selengkapnya >
                                                                </router-link>
                                                            </p>
                ...
                <div id="bagianCatatan" class="mb-2">
                    <div class="d-flex align-content-start flex-wrap mt-4">
                        <div v-if="this.togglePencarianCatatanPerwalianDosen" id="containerHasilCariCatatanPerwalian">
                            <div v-if="this.hasilPencarianCatatanPerwalianDosen.length >= 1 && this.hasilPencarianCatatanPerwalianDosen[0] != 'kosongError'"
                            ...
                            <div v-else-if="this.hasilPencarianCatatanPerwalianDosen.length >= 1 && this.hasilPencarianCatatanPerwalianDosen[0] == 'kosongError'"
                            ...
                            <div v-else-if="this.hasilPencarianCatatanPerwalianDosen.length == 0 && this.inputanCariCatatanPerwalianDosen != ''"
                                id="kolomHasilPencarian" class="d-flex align-items-center col-10">
                        ...
                        <div class="col-md-7 col-sm-12 px-0" id="catatanPerwalianDosen">
                            ...
                            <div class="col-12 mb-1 mt-xl-3 pl-0" id="containerCariCatatanPerwalian">
                                ...
                                <input id="inputCariCatatanPerwalian" type="text"
                                    placeholder="Cari catatan perwalian semua angkatan" @keyup="cariCatatanPerwalianDosen"
                                    @focus="scrollPage('catatan-perwalian-dosen')"
                    ...
                    <div id="listCatatanPerwalian" class="d-flex align-content-start flex-wrap mt-1 pb-3">
                                ...
                                <div id="itemCatatanPerwalian" class="card ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p v-else id="catatanCatatanGrupAngkatan" class="card-text text-justify">
                                            ...
                                            <span>
                                                <router-link
                                                    :to="`edit-catatan-grup-angkatan/${catatan.id_catatan_perwalian_dosen}`"
                                                    class="font-weight-bold"><u>Lihat selengkapnya</u></router-link>
                                            </span>
                                        </p>
                                    </div>
                        ...
                        <div class="col-12 d-flex justify-content-start mt-3 px-0">
                            <div id="lihatSemuaCatatan" class="px-0">
                                <router-link id="lihatSemuaCatatanPerwalianDosen"
                                    :to="{ name: 'DaftarCatatanPerwalianDosen' }">Lihat semua catatan
                ...
                <div id="bagianCatatanDosen">
                    <div class="d-flex align-content-start flex-wrap mt-4">
                        <div v-if="this.togglePencarianCatatanDosen" id="containerHasilCariCatatanPerwalian">
                            <div v-if="this.hasilPencarianCatatanDosen.length >= 1 && this.hasilPencarianCatatanDosen[0] != 'kosongError'"
                                id="kolomHasilPencarian" class="col-10">
                                <div class="d-flex flex-wrap col-12 py-2 px-1">
                                    <div v-for="(catatan, index) in this.hasilPencarianCatatanDosen" :key="index"
                                        class="col-6 my-3 px-0" id="itemCariCatatan">
                                        <div id="itemHasilPencarian" class="p-2">
                                            <span v-bind:class="{
                            ...
                            <div v-else-if="this.hasilPencarianCatatanDosen.length >= 1 && this.hasilPencarianCatatanDosen[0] == 'kosongError'"
                                id="kolomHasilPencarian" class="d-flex align-items-center col-10">
                        ...
                        <div class="col-md-7 col-sm-12 px-0">
                            <div id="judulCariCatatanPerwalian" class="d-flex col-12 pl-0">
                                ...
                                <div>
                                    ...
                                    <v-tooltip activator="parent" width="400"
                                        content-class="bg-grey-darken-1" location="bottom">Catatan Dosen merupakan catatan yang digunakan untuk Dosen Wali sendiri. Catatan Dosen Tipe 'Refleksi Dosen' sebagai pengingat / catatan untuk Dosen Wali. Sedangkan Catatan Dosen Tipe 'Khusus' sebagai catatan diluar semua tipe di Catatan Perwalian Dosen dan Catatan Dosen Tipe 'Refleksi Dosen' 
                                    </v-tooltip>
                                </div>
                            ...
                            <div class="col-12 mb-1 mt-xl-3 pl-0" id="containerCariCatatanPerwalian">
                                <span class="material-symbols-outlined search"> search </span>
                                <input id="inputCariCatatanDosen" type="text" placeholder="Cari catatan dosen"
                                    @keyup="cariCatatanDosen" @focus="scrollPage('catatan-dosen')"
                                    v-model="inputanCariCatatanDosen">
                            </div>
                ...
                <div id="bagianGrupAngkatan">
                    <div id="judulDaftarGrupPerwalian" class="mt-4">
                        ...
                        <div v-if="this.togglePencarianMahasiswa">
                            <div v-if="this.hasilPencarianMahasiswa.length >= 1 && this.hasilPencarianMahasiswa[0] != 'kosongError'"
                                id="kolomHasilPencarian" class="col-10">
                                <div class="d-flex flex-wrap col-12 py-2 px-1">
                                    <div v-for="(mahasiswa, index) in this.hasilPencarianMahasiswa" :key="index"
                                        id="itemHasilPencarian" class="col-6 my-0 px-0 itemNamaMahasiswa">
                                        <div class="p-2">
                                            <router-link :to="{ name: 'DetailMahasiswa', params: { id: mahasiswa.nim } }"
                                                class="m-0" id="namaMahasiswaHasilPencarian">
                            ...
                            <div v-else-if="this.hasilPencarianMahasiswa.length >= 1 && this.hasilPencarianMahasiswa[0] == 'kosongError'"
                                id="kolomHasilPencarian" class="d-flex align-items-center col-10">
                    ...
                    <div id="containerMahasiswaAngkatan" class="row mt-4 d-flex justify-content-center">
                        <div v-if="this.listTahunAngkatanBimbingan.length > 0" class="w-100 d-flex">
                            <div v-for="(tahunAngkatan, index) in this.listTahunAngkatanBimbingan" :key="index"
                                id="mahasiswaAngkatan" class="col-sm-12 col-md-12 col-lg-12 col-xl-6 mb-3 px-0">
                                <p>Mahasiswa Informatika {{ tahunAngkatan }}</p>
                                <div id="itemNamaMhs">
                                    <div v-for="(mahasiswa, index) in this.mahasiswaPerwalian.get(tahunAngkatan)"
                                        :key="index" id="itemMahasiswa" class="d-flex col-12 mb-sm-3 ">
                                        <!-- icon mahasiswa -->
                                        ...
                                        <div id="infoMahasiswa">
                                            <div>
                                                <p>
                                                    <router-link
                                                        :to="{ name: 'DetailMahasiswa', params: { id: mahasiswa.nim } }"
                                                        class="namaMahasiswa">
                                                        {{ mahasiswa.nama }} / {{ mahasiswa.nim }}
                                                    </router-link>
                                                </p>
                                            ...
                                            <div id="infoIPK">
                                                <div>
                                                    ...
                                                    <span v-if="mahasiswa.poin_keaktifan < 50" class="cekalSAC">
                                                        <v-tooltip activator="parent" width="400"
                                                            content-class="bg-grey-darken-1" location="bottom">Mahasiswa ini
                                                ...
                                                <div>
                                                    <div v-if="mahasiswa.list_cekal.length > 0" class="d-flex mt-1">
                                                        <span v-for="(cekal, index) in mahasiswa.list_cekal" :key="index"
                                                            class="d-inline-block">
                                                            <span v-if="cekal.cekal == 'Biro 2'" class="cekal mr-2">
                                                                <v-tooltip activator="parent" location="bottom"
                                                                    content-class="bg-grey-darken-1">{{ cekal.deskripsi }}
                                                                </v-tooltip>
                                                                {{ cekal.cekal }}
                                                            </span>
                                                            ...
                                                            <span v-else-if="cekal.cekal == 'Perpustakaan'"
                                                                class="cekal mr-2">
                                                                <v-tooltip activator="parent"
                                                                    content-class="bg-grey-darken-1" location="bottom">{{
                                                                        cekal.deskripsi }}
                                                                </v-tooltip>
                                                                {{ cekal.cekal }}
                                                            </span>
                            ...
                            <div v-for="(tahunAngkatan, index) in this.listTahunAngkatanBimbingan" :key="index"
                                ...
                                <div id="itemNamaMhs2">
                                    <div class="container" id="listNamaShimmer">
                                        <div v-for="(mahasiswa, index) in this.mahasiswaPerwalian.get(tahunAngkatan)"
                                            :key="index" id="itemMahasiswa" class="col mb-sm-2">
                                            <div class="line"></div>
                                        </div>
                                        <div class="shimmer"></div>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        // checkAksesLogin(){
        //     let aksesLogin = Cookies.get("auth")
        //     console.log("ini di beranda, akses login ",aksesLogin);
        //     if(aksesLogin === 'false'){
