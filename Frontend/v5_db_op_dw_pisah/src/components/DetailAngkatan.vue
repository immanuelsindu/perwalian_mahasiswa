                        ...
                        <div class="mt-3 ml-0">
                            <div>
                                <div v-if="this.listCatatanGrupAngkatanTerbaru.length > 0" class="d-flex flex-row"
                                    ...
                                    <div v-for="(catatan, index) in this.listCatatanGrupAngkatanTerbaru" :key="index"
                                        id="itemCatatan" class="card p-4 col-lg-3 mb-lg-4 col-md-6 mb-md-4 col-sm-12 mb-sm-4">
                                        <div id="judulCatatan">
                        ...
                        <div id="bagianPencarian" class="d-flex ml-3 mt-5 ">
                            <div class="col-12 m-0 p-0">
                                ...
                                <div id="alertPencarian" class="row mt-1 mb-3 ">
                                    <div class="p-0 m-0">
                                        <p class="p-0 m-0">{{ this.pesanError }}</p>
                                    </div>
                                </div>
                                ...
                                <div id="infoMahasiswaBimbingan" class="d-flex flex-row flex-wrap col-12">
                                     ...
                                     <div class="itemInfoMahasiswaBimbingan" :class="{ selected: this.selectedItems.includes('Semua Mahasiswa') }">
                                        <div class="d-flex align-items-center col-12 semuaMahasiswa" @click="this.toggleItemSelection('Semua Mahasiswa')">
                                    ...
                                    <div v-for="items in this.jumlahStatusPerwalian.get(this.$route.params.id)" :key="items" class="itemInfoMahasiswaBimbingan" :class="{ selected: this.selectedItems.includes(items.status) }">
                                ...
                                <div id="filterIPKSAC" class="d-flex flex-row  flex-wrap col-12">
                                    ...
                                    <div class="form-check mr-3 d-flex align-self-center">
                                        <input class="form-check-input" type="checkbox" value="true" v-model="this.filterIPK" id="checkboxIPK">
                                    ...
                                    <div class="form-check mr-3 d-flex align-self-center">
                                        <input class="form-check-input" type="checkbox" value="true" v-model="this.filterSAC" id="checkboxSAC">
                            ...
                            <div v-if="this.listMahasiswaPerwalianFiltered.length > 0" id="containerListMahasiswa"
                                ...
                                <TransitionGroup name="list">
                                    ...
                                    <div id="dataMahasiswa">
                                        <router-link id="namaNimMahasiswa"
                                            :to="{ name: 'DetailMahasiswa', params: { id: item.nim } }">
                                        ...
                                        <p>
                                            ...
                                            <span v-if="item.ipk < 2" class="warningIPK">
                                                ...
                                                content-class="bg-grey-darken-1">Mahasiswa ini memiliki IPK dibawah 2.00</v-tooltip>
                                                IPK {{ item.ipk }} 
                                            </span>
                                            <span v-else >
                                                IPK {{ item.ipk }} 
                                            ...
                                            <span v-if="this.isSACKurang(item.poin_keaktifan, item.nim)" class="cekalSAC m-0">
                                                <v-tooltip activator="parent" location="bottom" width="400"
                                                    content-class="bg-grey-darken-1">{{this.pesanSAC}}
                                                </v-tooltip>
                                        ...
                                        <span v-if="item.list_cekal">
                                            <span v-for="(cekal, index) in item.list_cekal" :key="index">
                                                <span v-if="cekal.cekal === 'Biro 1'" class="cekal mr-2">
                                                    <v-tooltip activator="parent" location="bottom"
                                                        content-class="bg-grey-darken-1">{{ cekal.deskripsi }}</v-tooltip>{{
                                                            cekal.cekal }}</span>
    ...
    methods: {
        ...
        async getJumlahStatusMahasiswa(){
            try {
                ...
                if (response.data.error === false) {
                    ...
                    //menghitung jumlah status mahasiswa
        ...
        async initListMahasiswa() {
            ...
            if (this.listMahasiswaPerwalianFiltered.length > 0) {
                this.pesanError = "Berhasil mendapatkan " + this.listMahasiswaPerwalianFiltered.length + " mahasiswa"
        ...
        async getOpsiUrutanDetailAngkatan() {
            try {
                ...
                if (response.data.error === false) {
                    this.opsiUrutanItemDetailAngkatan = response.data.response[0].opsi_detail_angkatan;
                } else {
    ...
    watch: {
        inputanCariMahasiswa: {
            handler: _.debounce(async function (baru) {
                console.log(baru);
                this.pesanError = "Sedang mencari mahasiswa ... "
                // ambi dari semula, filter chip, baru cari
                ...
                if (hasilFilter.length > 0) { //filter ketemu
                    ...
                    this.pesanError = "Berhasil menemukan " + hasilFilter.length + " mahasiswa"
                } else { // filter tidak ketemu 
                    this.listMahasiswaPerwalianFiltered = []
                    this.pesanError = "Mahasiswa yang dicari tidak ditemukan"
                }
            }, 300)
        },
        chipFilterStatus: {
