...
export default {
    ...
    methods: {
        ...
        async filteredCatatanArsip() {
            try {
                const response = await axios.get(process.env.VUE_APP_API_OPERASIONAL + `/filteredCatatanMahasiswaArsip/`, {
                    params: {
        ...
        showPopUpArsip(catatan) {
            ...
            if(catatan.tambah_peserta != null){
                ...
                this.pesanWarningArsip = "Setelah Anda memulihkan catatan, Anda dapat mengakses catatan tersebut di halaman \"Daftar Catatan Perwalian Mahasiswa\""
            }
        },
        arsipCatatanTidak() {
