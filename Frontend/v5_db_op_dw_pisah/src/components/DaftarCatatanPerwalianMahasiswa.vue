        ...
        <div class="col-12 mt-4">
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 pl-5 d-flex justify-content-center">
                    <div class="mr-3">
                        <router-link id="arsipCatatanPerwalian" :to="{
                                    name: 'ArsipPerwalianMahasiswa',
                                    params: {id: this.$route.params.id},
                                }" type="button" class="btn">
                            <v-tooltip activator="parent" location="bottom" content-class="bg-grey-darken-1">Lihat catatan yang diarsipkan
                            </v-tooltip>
                    ...
                    <div>
                        <button type="button" @click="showPopUpPreferensi()" class="btn filter">
                            ...
                            <v-tooltip activator="parent" location="bottom" content-class="bg-grey-darken-1">Filter urutan catatan
                            </v-tooltip>
                        </button>
                    </div>
                </div>
                        ...
                        <div id="windowPreferensi">
                            <div id="contentPreferensi" class="p-4">
                                <p class="text-center font-weight-bold mb-1">
                                    Pilih filter urutan catatan perwalian
                                </p>
                                <p class="text-center font-italic">
                                    Filter berikut tidak bisa digunakan di
                                    Daftar Catatan tampilan "History Catatan
                                    Perwalian"
                                </p>

                                <p class="text-center font-weight-bold">
                                    Pilih urutan catatan
                                </p>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <ol class="pl-0 listFilter">
                                            <li v-for="(
                                                        items, index
                                                    ) in listSort" :key="index" class="mb-1 pl-2">
                                                <div class="row">
                                                    <div class="col-8">
                                                        {{ items }}
                                                    </div>
                                                    <div class="col-4 pl-4 d-flex justify-content-center align-items-center">
                                                        <input class="form-check-input align-self-center" type="radio" name="flexRadioDefault" :id="
                                                                    'flexRadioDefault' +
                                                                    index
                                                                " :value="items" v-model="
                                                                    valueSort
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <ol class="pl-0 listFilter tipe">
                                            <li v-for="(
                                                        items, index
                                                    ) in listFilters" :key="index" class="mb-1 pl-2">
                                                <div class="row">
                                                    <div class="col-8">
                                                        {{ items }}
                                                    </div>
                                                    <div class="col-4 pl-4 d-flex justify-content-center align-items-center">
                                                        <input class="form-check-input align-self-center" type="radio" name="flexRadioDefault2" :id="
                                                                    'flexRadioDefault' +
                                                                    index
                                                                " :value="items" v-model="
                                                                    valueFilter
                                ...
                                <div class="row mt-2">
                                    <div class="col-4 px-0 d-flex justify-content-center">
                                        <button class="btn batal filter" @click="batal()">
                                            Batal
                                        </button>
                                    </div>
                                    <div class="col-4 offset-4 px-0 d-flex justify-content-center">
                                        <button class="btn simpan filter" @click="simpan()">
                                            Simpan
                                        </button>
                                    </div>
                                </div>
        ...
        <div class="container px-0">
            ...
            <div id="cariCatatanPerwalian" class="row">
                <div class="col-md-5 mt-2">
                    <div class="mb-1">
                        ...
                        <input id="inputCariMahasiswa" type="text" placeholder="Cari catatan perwalian" v-model="inputanCariCatatanPerwalianMahasiswa" />
                    </div>
                ...
                <div class="col-md-3">
                    <div id="opsiTambahNHistoryKanan">
                        <router-link :to="{name: 'TambahCatatanMahasiswa',params: { canBack: 1 }}" id="tambahCatatan" class="align-middle">
                            <span class="material-symbols-outlined mr-1 pt-1">
                                add_box
                            </span>
                        </router-link>
                        <router-link :to="{name: 'TambahCatatanMahasiswa', params: { canBack: 1 }}" id="tambahCatatan" class="judulTambahCatatan">
            ...
            <div id="cardCatatanPerwalian" class="mt-2 mb-5 pt-3">
                <div class="d-flex justify-content-start">
                    <!-- untuk bagian tampilkan history catatan perwalian  -->
                    <div v-if="this.isHistory" class="row d-flex justify-content-center w-100">
                        <div v-if="this.cekListCatatanMahasiswaHistory() !== 0" class="d-flex">
                            <div class="col-4 pl-0 mt-5">
                                <div id="garis"></div>
                                <div v-for="(tahunCatatan, tahun) in this
                                            .listCatatanMahasiswaHistori" :key="tahun" class="mb-4">
                                    <p id="tahunCatatanPerwalian">
                                        {{ tahun }}
                                    </p>

                                    <!-- tahunCatatan == list catatan per tahun -->
                                    <div id="test" class="pt-1">
                                        <div v-for="catatan in tahunCatatan" :key="
                                                    catatan.id_catatan_perwalian_dosen
                                            ...
                                            <div id="tanggalPerwalian" class="col-9 px-0 pl-1">
                                                <p>
                                                    <span v-if="
                                                                catatan.tipe ==
                                                                'mahasiswa'
                            ...
                            <div class="col-8 pl-0 mt-5">
                                <div v-if="this.dataShowPreviewCatatan != ''" id="mySticky">
                                ...
                                <div v-else id="mySticky">
                                    <div class="card" id="cardPreviewCatatan">
                                        <div class="card-body p-4">
                                            <p id="suggestText">
                                                Silahkan pilih catatan di
                                                sisi kiri untuk menampilkan
                                                preview catatan
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <!-- jika tidak ada catatan di listCatatanHistoryMahasiswa -->
                        <div v-else class="d-flex">
                            <div class="card d-inline-block mx-auto" id="cardPreviewCatatan">
                                <div class="card-body p-4">
                                    <p id="suggestText">
                                        Tidak ada catatan perwalian
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- untuk menampilkan daftar catatan mahasiswa biasa (bukan histori) -->
                    <div v-else id="panelHistory" class="row mt-2 px-0">
                                ...
                                <div id="itemCatatanPerwalian">
                                        ...
                                        <div id="infoCatatan" class="col-12">
                                            <div class="d-flex">
                                                <div class="col-11 pl-0">
                                                    <p class="p-0 text-break judulCatatan">
                                                        {{
                                                                this.limitJudul(
                                                                    catatan.judul
                                                                )
                                                ...
                                                <div class="col-1 px-0">
                                                    <p>
                                                        <span id="iconDelete" class="material-symbols-outlined delete" @click="
                                                                    showPopUpHapus(
                                                                        catatan
                                                                    )
                                                                ">
                                    ...
                                    <div id="tombolEditAchive" class="d-flex">
                                        ...
                                        <div class="col-6 px-0 text-right">
                                            <button id="buttonArsip" type="button" class="btn btn-light" @click="
                                                        showPopUpArsip(catatan)
                                                    ">
                                                Arsipkan
                                            </button>
                                        </div>
                        ...
                        <!-- jika tidak ada data di pagination -->
                        ...
                        <v-row justify="center">
                            <v-col cols="8">
                                <v-container class="max-width">
                                    <v-pagination v-model="this.currentPage" :length="this.getListCatatanLength" @input="this.changePage()" prev-icon="mdi-menu-left" next-icon="mdi-menu-right"></v-pagination>
                                </v-container>
                            </v-col>
                        </v-row>
                    </v-container>
        ...
        <div id="overlay" v-if="this.showWarningHapus" class="d-flex justify-content-center align-items-center">
            <div id="windowPreferensi">
                <div id="contentPreferensi" class="p-4">
                    ...
                    <p class="px-3 text-center text-danger">
                        {{ this.pesanWarningHapus }}
                    </p>

                    <div v-if="
                                this.relasiCatatanHapus.tambah_peserta.length >
                                0
                            ">
                    ...
                    <div class="row mt-4">
                        <div class="col-4 px-0 d-flex justify-content-center">
                            <button class="btn batal hapus" @click="hapusCatatanTidak()">
                                Tidak
                            </button>
                        </div>
                        <div class="col-4 offset-4 px-0 d-flex justify-content-center">
                            <button class="btn simpan hapus" @click="hapusCatatanYa()">
                                Ya
                            </button>
                        </div>
                    </div>
    ...
    <Transition>
        <div id="overlay" v-if="this.showWarningArsip" class="d-flex justify-content-center align-items-center">
            <div id="windowPreferensi">
                <div id="contentPreferensi" class="p-4">
                    <p class="text-center font-weight-bold mb-3">
                        Yakin arsipkan catatan ?
                    </p>
                    <p class="px-3 text-justify">
                        {{ this.pesanWarningArsip }}
                    </p>

                    <div v-if="
                                this.relasiCatatanArsip.tambah_peserta.length >
                                0
                            ">
                        <v-divider :thickness="3" class="border-opacity-100 mx-4 mt-2 mb-3" color="success"></v-divider>
                        <p class="mb-3 text-center">
                    ...
                    <div class="row mt-4">
                        <div class="col-4 px-0 d-flex justify-content-center">
                            <button class="btn batal arsip" @click="arsipCatatanTidak()">
                                Tidak
                            </button>
                        </div>
                        <div class="col-4 offset-4 px-0 d-flex justify-content-center">
                            <button class="btn simpan arsip" @click="arsipCatatanYa()">
                                Ya
                            </button>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            listSort: ["Paling Baru", "Paling Lama"],
            listFilters: [
                "Semua Tipe",
                "Mahasiswa",
                "Orang Tua / Wali",
            ...
            namaMahasiswa: "",
            listTempCatatanMahasiswaHistory: [],
            listCatatanMahasiswaHistori: new Map(),
            inputanCariCatatanPerwalianMahasiswa: "",
            idHapus: 0,
            idArsip: 0,
    ...
    methods: {
        async initData() {
            ...
            // this.namaMahasiswa = localStorage.getItem("namaMahasiswa")
            //get daftar catatan mahasiswa
            await this.getFilteredCatatanMahasiswa();
            // load data fitur catatan mahasiswa mode histori
            await this.loadCatatanMahasiswaHistori(); // daftar catatan dengan tahun_catatan
            //membuat map untuk catatan mahasiswa mode history
            this.setMapListCatatanMahasiswaHistori(); // menunggu 3 method di atas

            this.getNamaNimMahasiswa();
        },
        async getNamaNimMahasiswa() {
            try {
                ...
                if (response.data.error === false) {
                    this.namaMahasiswa =
                        response.data.response.list_mahasiswa[0].nama;
                } else {
                    this.namaMahasiswa = [];
                }
            } catch (error) {
        ...
        async getFilteredCatatanMahasiswa() {
            try {
                const response = await axios.get(
                    process.env.VUE_APP_API_OPERASIONAL + `/filteredCatatanMahasiswa/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
                ...
                if (response.data.error === false) {
                    this.listCatatanMahasiswa =
                        response.data.response.list_catatan_mahasiswa;
                    this.pesanError =
                        "Berhasil menemukan " +
                        this.listCatatanMahasiswa.length +
                        " data";

                    //return untuk watch pencarian
                    return this.listCatatanMahasiswa;
                } else {
                    this.listCatatanMahasiswa = [];
        ...
        async loadCatatanMahasiswaHistori() {
            try {
                const response = await axios.get(
                    process.env.VUE_APP_API_OPERASIONAL + `/catatanMahasiswaHistory/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
                            nim: this.$route.params.id,
                        },
                ...
                if (response.data.error === false) {
                    this.listTempCatatanMahasiswaHistory =
                        response.data.response.list_catatan_mahasiswa;
                } else {
                    this.listTempCatatanMahasiswaHistory = [];
                }
        ...
        async getTahunCatatanMahasiswaHistori() {
            try {
                const response = await axios.get(
                    process.env.VUE_APP_API_OPERASIONAL + `/tahunCatatanMahasiswaHistory/`, {
                        params: {
                            kode_dosen: this.kodeDosen,
                            nim: this.$route.params.id,
                        },
                ...
                if (response.data.error === false) {
                    this.listTahunCatatanMahasiswaHistori =
                        response.data.response.list_tahun;
                } else {
                    this.listTahunCatatanMahasiswaHistori = [];
                }
            } catch (error) {
        ...
        async setMapListCatatanMahasiswaHistori() {
            // membuat variabel baru untuk menampung catatan berdasarkan tahun_catatan
            const catatanPerTahun =
                await this.listTempCatatanMahasiswaHistory.reduce(
                    (result, catatan) => {
                        const tahunCatatan = catatan.tahun_catatan;
                        if (!result[tahunCatatan]) {
                            result[tahunCatatan] = [];
                        }
                        result[tahunCatatan].push(catatan);
                        return result;
                    }, {}
                );
            this.listCatatanMahasiswaHistori = catatanPerTahun;
        },
        simpan() {
            this.getFilteredCatatanMahasiswa();
        ...
        editCatatan() {
            window.open(
                this.$router.resolve("/editCatatanMahasiswa").href,
                "_blank"
            );
        },
        bukaArsip() {
            window.open(
                this.$router.resolve("/arsipPerwalianDosen").href,
                "_blank"
            );
        },
        scrollTop() {
        ...
        cariCatatanPerwalianMahasiswa(judul) {
            const filteredCatatanPerwalian =
                this.listAllCatatanPerwalianMahasiswa.filter(item => {
                    return item.judul
                        .toLowerCase()
                        .includes(judul.toLowerCase());
                });
        ...
        async setIdShowPreviewCatatan(idCatatan) {
            const catatanDitemukan =
                await this.listTempCatatanMahasiswaHistory.find(
                    catatan => catatan.id_catatan_perwalian_dosen === idCatatan
                );
            this.dataShowPreviewCatatan = catatanDitemukan;
        },
        convertToWIB(waktu) {
        ...
        async showPopUpHapus(catatan) {
            ...
            if (catatan.tambah_peserta.length != 0) {
                ...
                this.pesanWarningHapus =
                    "Catatan ini memiliki relasi dengan catatan lain, menghapus catatan ini berarti menghapus secara permanen semua catatan yang berelasi dengan catatan ini";
            } else {
                this.relasiCatatanHapus = {
                    judul: "kosong",
                    tambah_peserta: [],
        ...
        async hapusCatatanYa() {
            ...
            if (this.relasiCatatanHapus.tambah_peserta.length != 0) {
                for (
                    let i = 0; i < this.relasiCatatanHapus.tambah_peserta.length; i++
                ) {
                    const paramObject = {
                        id_catatan_perwalian_dosen: this.relasiCatatanHapus.tambah_peserta[i]
                            .id_catatan_perwalian_dosen,
                    };
                    await axios.put(
                        process.env.VUE_APP_API_OPERASIONAL +
                        `/deleteCatatanPerwalianDosen/`,
                        paramObject
                    );
                }
        ...
        async showPopUpArsip(catatan) {
            ...
            if (catatan.tambah_peserta.length != 0) {
                ...
                this.pesanWarningArsip =
                    "Catatan ini memiliki relasi dengan catatan lain, mengarsipkan catatan ini berarti mengarsipkan semua catatan yang berelasi dengan catatan ini";
            } else {
                this.relasiCatatanArsip = {
                    judul: "kosong",
                    tambah_peserta: 0,
                ...
                this.pesanWarningArsip =
                    "Ketika catatan ini diarsipkan, Anda tidak bisa mengaksesnya. Namun, Anda dapat memulihkan catatan tersebut melalui menu 'Lihat catatan yang diarsipkan' yang berada di pojok kanan atas halaman ini";
            }
        },
        arsipCatatanTidak() {
        ...
        async arsipCatatanYa() {
            if (this.relasiCatatanArsip.tambah_peserta.length != 0) {
                for (let i = 0; i < this.relasiCatatanArsip.tambah_peserta.length; i++) {
                    const paramObject = {
                        id_catatan_perwalian_dosen: this.relasiCatatanArsip.tambah_peserta[i]
                            .id_catatan_perwalian_dosen,
                        is_arsip: true,
        ...
        cekListCatatanMahasiswaHistory(){
            let tempHasil = Object.keys(this.listCatatanMahasiswaHistori)
            if(tempHasil.length >0){ 
                return 1 // true, == berarti list catatan ada isinya
            }else{
                return 0 // false == berarti list catatan kosong
            }
        }
    },
    mounted() {
    ...
    computed: {
        getListCatatanLength() {
            let hasil = Math.ceil(this.listCatatanMahasiswa.length / 12);
            return hasil;
        },
        paginatedItems() {
            this.scrollTop();
            ...
            return this.listCatatanMahasiswa.slice(startIndex, endIndex);
        },
    },
    watch: {
        valueSort: {
        ...
        inputanCariCatatanPerwalianMahasiswa: {
            handler: async function (judul) {
                ...
                if (tempListCatatanMahasiswa != undefined) {
                    hasilFilter = tempListCatatanMahasiswa.filter(
                        catatan =>
                        catatan.judul
                        .toLowerCase()
                        .includes(kataKunciPencarian) ||
                        catatan.agenda_perwalian
                        .toLowerCase()
                        .includes(kataKunciPencarian)
                    );
                ...
                if (hasilFilter.length > 0) {
                    //filter ketemu
                    this.listCatatanMahasiswa = hasilFilter;
                    this.pesanError =
                        "Berhasil menemukan " + hasilFilter.length + " data";
                } else {
                    // filter tidak ketemu
                    // this.listCatatanMahasiswa = tempListCatatanMahasiswa
                    this.listCatatanMahasiswa = [];
...
<style
    scoped
    src="../../public/frontend/styling/cariCatatanPerwalianMahasiswa.css"
></style>
