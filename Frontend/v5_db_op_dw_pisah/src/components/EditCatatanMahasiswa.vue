        ...
        <div class="d-flex flex-column">
            <div class="container-fluid px-0 mt-4 pt-2">
                ...
                <div id="tambahCatatan" class="myContainer d-flex">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3 pl-2">
                                <div class="row">
                                    ...
                                    <div class="col-9 align-self-center">
                                        <input id="inputKiri" type="text" v-model="nama" readonly disabled />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-9 col-sm-9 mb-sm-4 pl-0" id="cariTambahMahasiswa">
                                ...
                                <div id="kolomTambahMahasiswa" class="d-flex align-items-center">
                                    ...
                                    <input class="inputCariMahasiswa" type="text" placeholder="Cari nama mahasiswa" v-model="inputanNamaMahasiswa" v-bind:class="{
                                                inputCariMahasiswaFocus:
                                                    showSuggestionList,
                                            }" />
                                </div>
                                <Transition>
                                    <div v-if="
                                                this.listCariNamaMahasiswa
                                                    .length > 0 &&
                                                this.inputanNamaMahasiswa != ''
                                            " id="hoverCariNamaMahasiswa">
                                        <div id="listNamaPesertaLain" class="py-1 px-0">
                                            <ol class="list-group">
                                                <li v-for="(
                                                            mahasiswa, index
                                                        ) in this
                                                            .listCariNamaMahasiswa" :key="index" class="list-group-item py-1">
                                                    <div class="row">
                                                        <div class="col-10">
                                                            <p class="mb-0">
                                                                {{
                                                        ...
                                                        <div class="col-2 px-0 d-flex align-items-center">
                                                            <span class="material-symbols-outlined delete text-success" @click="
                                                                        addPeserta(
                                                                            mahasiswa.nim,
                                                                            mahasiswa.nama
                                                                        )
                    ...
                    <div class="col-lg-3 col-md-8 col-sm-9 p-0">
                        <transition>
                            <div v-if="
                ...
                <div id="windowPreferensi">
                    <div id="contentPreferensi" class="p-4">
                        ...
                        <p class="px-3 text-justify">
                            Ketika catatan ini diarsipkan, Anda tidak bisa
                            mengaksesnya. Namun, Anda dapat memulihkan
                            catatan tersebut melalui menu
                            <span><b>'Lihat catatan yang diarsipkan'</b></span>
                            yang berada di pojok kanan atas halaman ini
                        </p>
                        <div class="row mt-4">
                            <div class="col-4 px-0 d-flex justify-content-center">
                                <button class="btn batal" @click="arsipCatatanTidak()">
                                    Tidak
                                </button>
                            </div>
                            <div class="col-4 offset-4 px-0 d-flex justify-content-center">
                                <button class="btn simpan" @click="arsipCatatanYa()">
                                    Ya
                                </button>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        async initData() {
            ...
            //get catatan by this.idCatatanPerwalianDosen
            try {
            ...
            if (this.data != null) {
                ...
                // daftar peserta lainnya
                if (this.data.tambah_peserta != null) {
            ...
            if (this.nim != nim) {
                if (!this.isMahasiswaExists(nim)) {
                    if (this.listMahasiswaPesertaLainnya.length < 5) {
                        ...
                        this.pesanSnackBar =
                            "Maksimal peserta lain hanya 5 orang";
                        this.snackbar();
                    }
                } else {
                    this.pesanSnackBar =
        ...
        async simpan() {
            ...
            if (!this.isFieldKosong()) {
                        ...
                        if (this.listMahasiswaPesertaLainnya[i].nim != this.nim) {
                            ...
                            // jika peserta lain tidak punya id_catatan yang di insert sebelumnya , berarti dia peserta baru => insert data baru
                                ...
                                let tempParamObject = {
                                    ...
                                    waktu_awal: this.waktuAwal,
                                    waktu_akhir: this.waktuAkhir,
                                    data_presensi_mahasiswa: [], // datanya memang kosong
                                    tahun_angkatan: "", // datanya memang kosong
                                };

                                try {
                                    const response = await axios.post(
                                        process.env.VUE_APP_API_OPERASIONAL +
                                        `/tambahCatatanPerwalianDosen/`,
                                        tempParamObject
                                    );
                ...
                this.pesanSnackBar =
                    "Agenda perwalian atau judul tidak boleh kosong";
                this.snackbar();
            }
        },
        batal() {
        ...
        async cariNamaMahasiswa() {
            try {
                ...
                if (response.data.error === false) {
                    this.listCariNamaMahasiswa =
                        response.data.response.list_mahasiswa;
                } else {
                    this.listCariNamaMahasiswa = [];
                }
            } catch (error) {
        ...
        async arsipCatatanYa() {
            ...
            if (tempCatatan.tambah_peserta != []) {
                ...
                for (let i = 0; i < daftarPesertaLainnya.length; i++) {
                    ...
                    try {
                        const paramObject = {
                            id_catatan_perwalian_dosen: daftarPesertaLainnya[i]
                                .id_catatan_perwalian_dosen,
                            is_arsip: true,
                        };
                        await axios.put(
...
<style
    scoped
    src="../../public/frontend/styling/editCatatanMahasiswa.css"
></style>
